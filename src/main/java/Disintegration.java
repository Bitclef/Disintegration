...
public class Disintegration extends Application {
...
//                    new KeyFrame(Duration.seconds(Math.random() * 3), values.subList(
//                            i * chunkSize, i == chunks - 1 ? values.size() : (i + 1) * chunkSize).toArray(new KeyValue[0])));
//        }
    ...
    public static void main(String[] args){
        ...
        Application.launch(Disintegration.class, args);
    }
}
